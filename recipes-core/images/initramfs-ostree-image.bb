...
PACKAGE_INSTALL = "ostree-switchroot initramfs-ostree bash kmod bzip2 sed tar kbd coreutils util-linux grep gawk udev mdadm base-passwd ${ROOTFS_BOOTSTRAP_INSTALL} ${CUBE_BUILDER_INITRAMFS_EXTRA_INSTALL} rng-tools findutils gzip e2fsprogs-tune2fs e2fsprogs-resize2fs pv util-linux-blkid util-linux-lsblk"
